...
def main():
    # yes, I know there is probably no need for sub-functions had I structured the code better, did I do it? No.
    ...
    try:
        ...
        # but don't hesitate to email me to tell me how much of an abomination you found my code to be
